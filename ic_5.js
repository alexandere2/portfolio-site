...
console.log(`Discount for gear': $${getCategoryDiscount('gear')}`);
console.log(`Discount for apparel': $${getCategoryDiscount('apparel')}`);
console.log(`Discountfor snacks: $${gettCategoryDiscount('snacks')}`);
console.log(`Discount for access: $${getCategoryDiscount(``)}`)
